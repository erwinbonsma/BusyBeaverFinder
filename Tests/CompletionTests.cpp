...
TEST_CASE("7x7 One-Shot Completion tests", "[success][7x7]") {
    ...
    SECTION("BB 7x7 #727440") {
        RunResult result = hangExecutor.execute("d++vCSlUqstVbYFnus");

        REQUIRE(result == RunResult::SUCCESS);
        REQUIRE(hangExecutor.numSteps() == 727440);
    }
    ...
    SECTION("BB 7x7 #932397") {
        RunResult result = hangExecutor.execute("d+v+QLxq+FaVGqR0Gs");

        REQUIRE(result == RunResult::SUCCESS);
        REQUIRE(hangExecutor.numSteps() == 932397);
    }
...
TEST_CASE("7x7 One-Shot Completion tests (> 100M)", "[.explicit][success][7x7]") {
    ...
    SECTION("BB 7x7 #202,750,833") {
        ...
        // * _ o o o *
        // o o o * *
        RunResult result = hangExecutor.execute("d/r/kC5Q4SvpShW1a8");
    ...
    SECTION("BB 7x7 #349,950,177") {
        ...
        // * o * _ _
        // o o *   *
        RunResult result = hangExecutor.execute("d/u/wC5E8ZuFbmD1u8");
    ...
    SECTION("BB 7x7 #819,045,700") {
        ...
        // o * _ _ o *
        // o     * *
        RunResult result = hangExecutor.execute("d/o/lLhb7hJBbYG368");

        REQUIRE(result == RunResult::SUCCESS);
        REQUIRE(hangExecutor.numSteps() == 819045700);
    }
    SECTION("BB 7x7 #918,785,139") {
        //   *       _
        //   _ _ _ * _
        // * _ o o o _ *
        // * * * * o _
        ...
        // o * _ _ o *
        // o       *
        RunResult result = hangExecutor.execute("d+/PAjhUqpNBbYG3+8");

        REQUIRE(result == RunResult::SUCCESS);
        REQUIRE(hangExecutor.numSteps() == 918785139);
    }
}
